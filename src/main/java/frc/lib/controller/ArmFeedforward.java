...
public class ArmFeedforward {
  ...
  public ArmFeedforward(edu.wpi.first.math.controller.ArmFeedforward feedforward) {
    this.ks = feedforward.ks;
    this.kg = feedforward.kg;
    this.kv = feedforward.kv;
    this.ka = feedforward.ka;
  }
