...
public class SwerveControllerCommand extends Command {
  ...
  public SwerveControllerCommand(
    ...
    this.controller = new SwerveDriveController(xController, yController, rotationController);
  ...
  public void execute() {
    ...
    TrajectoryState desiredState = (TrajectoryState) this.trajectory.sample(currentTime);
