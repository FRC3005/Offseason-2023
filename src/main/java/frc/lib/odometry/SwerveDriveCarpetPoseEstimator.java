 ...
 *
 * <p>{@link SwerveDriveCarpetPoseEstimator#update} should be called every robot loop.
 *
 * <p>{@link SwerveDriveCarpetPoseEstimator#addVisionMeasurement} can be called as infrequently as
 * you want; if you never call it, then this class will behave as regular encoder odometry.
 */
public class SwerveDriveCarpetPoseEstimator {
  private final SwerveDriveCarpetKinematics m_kinematics;
  private final SwerveDriveCarpetOdometry m_odometry;
   ...
   */
  public SwerveDriveCarpetPoseEstimator(
  ...
  public SwerveDriveCarpetPoseEstimator(
    ...
    m_odometry =
        new SwerveDriveCarpetOdometry(kinematics, gyroAngle, modulePositions, carpetTransform);
   ...
   * SwerveDriveCarpetPoseEstimator#update} every loop.
   *
   ...
   *     SwerveDriveCarpetPoseEstimator#updateWithTime(double,Rotation2d,SwerveModulePosition[])}
   ...
   * SwerveDriveCarpetPoseEstimator#setVisionMeasurementStdDevs(Matrix)} or this method.
   *
   * @param visionRobotPoseMeters The pose of the robot as measured by the vision camera.
   * @param timestampSeconds The timestamp of the vision measurement in seconds. Note that if you
   *     don't use your own time source by calling {@link
